...
{
$insert = $conn->query("INSERT into registration (username,password,email,phone,gender,dob,address,image_name,profile_image,date_time) VALUES ('$userName', '$userPassword','$userEmail','$userPhone','$userGender','$birthDate','$userAddress','$file_name','$file_image','$currentDateTime')");
