...
<br>
<div align="center">
<form action="registration_db.php" method="post" name="rform" onsubmit="return form_validation();" enctype="multipart/form-data">
...
<br>
<br>
<h2 id="text" onmousedown="mouse_Down();" onmouseup="mouse_Up();">Already Registered? - </h2><a id="login" href="login.php">Login</a>
<script type="text/javascript">
function mouse_Down()
{
