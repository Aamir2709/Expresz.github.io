...
echo "<script>window.location='Office Supplies.php'</script>";
}
else
{
...
.header-2 .navbar a:hover .category1 a:hover
{
...
<section class="product" id="product">
    ...
    <h1 class="heading">Office <span>Supplies</span></h1>
...
?>
        ...
        <div class="box">
            ...
            <div class="icons">
<form action="Office Supplies.php" method="post">
