...
echo "<script>window.location='Writing Instruments.php'</script>";
}
else
{
...
.header-2 .navbar a:hover .category4 a:hover
{
...
<section class="product" id="product">
    ...
    <h1 class="heading">Writing <span> Instruments</span></h1>
...
?>
        ...
        <div class="box">
            ...
            <div class="icons">
<form action="Writing Instruments.php" method="post">
