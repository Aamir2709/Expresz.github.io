...
echo "<script>window.location='Art and Crafts.php'</script>";
}
else
{
...
.header-2 .navbar a:hover .category2 a:hover
{
...
<section class="product" id="product">
    ...
    <h1 class="heading">Art <span>And </span>Crafts</h1>
...
?>
        ...
        <div class="box">
            ...
            <div class="icons">
<form action="Art and Crafts.php" method="post">
