...
<br>
<div align="center">
<form action="add_category_db.php" method="post" name="cform" onsubmit="return form_validation();" enctype="multipart/form-data">
<fieldset class="form_border">
<div class="form_heading">
<span><i class="fa-solid fa-cart-plus fa-7x add_item_icon"></i></span>
<label style="width: 400px; color: white;  text-align: center; font-size: 40px; font-variant: small-caps; font-family: Arial;"><b>Add Category</b></label>
</div>
<br>
<br>
<br>
...
<label id="description_heading">Description</label>
	<textarea  id="description_field" name="cdescription" cols="41"  rows="4" placeholder=" Enter Category Description!"></textarea>
</p>
<br>
<br>
<br>
