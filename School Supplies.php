...
echo "<script>window.location='School Supplies.php'</script>";
}
else
{
...
.header-2 .navbar a:hover .category5 a:hover
{
...
<section class="product" id="product">
    ...
    <h1 class="heading">School <span>Supplies</span></h1>
...
?>
        ...
        <div class="box">
            ...
            <div class="icons">
<form action="School Supplies.php" method="post">
